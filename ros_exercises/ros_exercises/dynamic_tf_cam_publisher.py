...
class DynamicTfCamPublisher(Node):
    ...
    def __init__(self):
        ...
        self.left = -0.05 # relative to base_line_gt pose
        self.right = 0.05 # relative to base_line_gt pose
    ...
    def node_callback(self):
        ...
        left_to_robot_translation = [self.left, 0, 0]
        ...
        ## right camera
        right_to_left_translation = [2*self.right, 0, 0]
